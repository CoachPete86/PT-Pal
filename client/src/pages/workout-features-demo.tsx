...
export default function WorkoutFeaturesDemo() {
  ...
  const [mascotMessage, setMascotMessage] = useState(
    "I'm your workout buddy! Let's get fit together!",
  );
  ...
  const workoutPlans = [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          name: "Burpees",
          duration: 30,
          instruction: "Full extension at the top",
          restAfter: 10,
        },
        {
          id: "ex4",
        ...
        },
        {
          ...
          name: "Plank Jacks",
          duration: 30,
          instruction: "Maintain plank position",
          restAfter: 30,
        },
        {
          id: "ex6",
        ...
        },
        {
          ...
          name: "Cool Down",
          duration: 60,
          instruction: "Deep breathing, gentle stretches",
          restAfter: 0,
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          name: "Warm Up",
          duration: 60,
          instruction: "Light cardio & dynamic stretches",
          restAfter: 10,
        },
        {
          id: "ex2",
          ...
          duration: 40,
          reps: 15,
          instruction: "Knees track with toes",
          restAfter: 20,
        },
        {
          id: "ex3",
          ...
          duration: 40,
          reps: 12,
          instruction: "Modify on knees if needed",
          restAfter: 20,
        },
        {
          id: "ex4",
        ...
        },
        {
          ...
          duration: 120,
          instruction: "Hold each stretch for 20 seconds",
          restAfter: 0,
        },
      ],
    },
      ...
      <div className="container mx-auto py-6 max-w-6xl">
        ...
        <Tabs defaultValue="voice-workout">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="voice-workout">
              Voice-Activated Workouts
            </TabsTrigger>
            <TabsTrigger value="motivation-coach">
              AI Motivation Coach
            </TabsTrigger>
              ...
              <div>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Control your workout with voice commands for a hands-free
                      experience
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            const workout = workoutPlans.find(
                              (w) => w.id === value,
                            );
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <ol className="list-decimal pl-5 space-y-2 text-sm">
                    ...
                    <li>
                      Say "start" to begin the workout, or click the play button
                    </li>
                    <li>
                      Follow along with the exercises as they auto-progress
                    </li>
                    <li>Try commands like "pause", "next", or "previous"</li>
                    <li>
                      The AI coach will provide guidance and encouragement
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted p-4 rounded-md space-y-2">
                        <h4 className="font-medium">
                          Motivation Coach Features:
                        </h4>
                        <ul className="list-disc pl-5 space-y-1 text-sm">
                          <li>
                            Phase-based motivation (warm-up, main, final push,
                            cool-down)
                          </li>
                          <li>
                            Voice guidance with adjustable volume and speed
                          </li>
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>
                      <strong>Coach:</strong> Direct, motivational, focused on
                      effort and results
                    </li>
                    <li>
                      <strong>Gym Buddy:</strong> Friendly, supportive,
                      encouraging with positive energy
                    </li>
                    <li>
                      <strong>Scientist:</strong> Fact-based, educational,
                      focuses on body mechanics
                    </li>
                    <li>
                      <strong>Zen Master:</strong> Mindful, philosophical,
              ...
              <div>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Customizable workout companion that provides visual
                      motivation
                    </CardDescription>
                  </CardHeader>
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-sm">
                    <li>
                      Appears during key workout moments for encouragement
                    </li>
                    <li>
                      Provides visual reinforcement with animated entrances
                    </li>
                    <li>
                      Displays personalized messages based on workout context
                    </li>
                    <li>
                      Character selection matches user's preferred coaching
                      style
                    </li>
                  </ul>
                </div>
