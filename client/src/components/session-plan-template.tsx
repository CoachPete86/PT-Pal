    ...
    <div className="max-w-4xl mx-auto p-6 font-sans bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-lg shadow-md">
          ...
          <table className="w-full border-collapse mb-2 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            ...
            <tbody>
              {warmup.exercises.map((ex, idx) => (
                <tr
                  key={idx}
                  className="border-b border-orange-100 dark:border-orange-900/30 hover:bg-orange-50 dark:hover:bg-orange-900/10"
                >
      ...
      <section className="mb-8">
        ...
        {mainWorkout.map((block, idx) => (
          <div
            key={idx}
            className="mb-8 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md"
          >
              ...
              <table className="w-full border-collapse bg-white dark:bg-gray-700 shadow rounded-lg overflow-hidden">
                ...
                <tbody>
                  {block.exercises.map((ex, i) => (
                    <tr
                      key={i}
                      className="border-b border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                    >
                      <td className="p-3 font-medium">{ex.exercise}</td>
            ...
            <table className="w-full border-collapse mb-2 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
              ...
              <tbody>
                {extraWork.exercises.map((ex, idx) => (
                  <tr
                    key={idx}
                    className="border-b border-purple-100 dark:border-purple-900/30 hover:bg-purple-50 dark:hover:bg-purple-900/10"
                  >
                    <td className="p-3 font-medium">{ex.exercise}</td>
      ...
      <section className="mb-8 bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border-l-4 border-blue-400">
        ...
        <p className="mb-4 font-medium">
          <strong className="text-blue-600 dark:text-blue-400">Purpose:</strong>{" "}
          ...
          <table className="w-full border-collapse mb-2 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            ...
            <tbody>
              {cooldown.exercises.map((ex, idx) => (
                <tr
                  key={idx}
                  className="border-b border-blue-100 dark:border-blue-900/30 hover:bg-blue-50 dark:hover:bg-blue-900/10"
                >
                  <td className="p-3 font-medium">{ex.exercise}</td>
