...
const AIMotivationCoach: React.FC<AIMotivationCoachProps> = ({
  ...
  const [phase, setPhase] = useState<'warm-up' | 'main-workout' | 'final-push' | 'cool-down'>(currentPhase);
  ...
  const generateNewMessage = () => {
    ...
    const phaseMessages = MOTIVATIONAL_PATTERNS.find(p => p.phase === phase)?.messages || [];
    ...
    <Card className="w-full max-w-md">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Let your coach motivate your workout</CardDescription>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <Badge variant="secondary" className="capitalize">{phase.replace('-', ' ')}</Badge>
        </div>
          ...
          {enableSpeech && (
            <>
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <Label htmlFor="speech-volume" className="text-xs">Volume</Label>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <Label htmlFor="speech-rate" className="text-xs">Speech Rate</Label>
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center">
            <Label htmlFor="message-frequency" className="text-xs">Message Frequency</Label>
                ...
                navigator.mediaDevices.getUserMedia({ audio: true })
                  .then(() => {
                    toast({
                      ...
                      description: "Say 'Next' for new tip, 'Play' or 'Pause' to control."
                    });
                  })
                  .catch(() => {
                    toast({
