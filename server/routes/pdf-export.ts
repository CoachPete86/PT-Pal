...
export async function exportWorkoutToPdf(req: Request, res: Response) {
  try {
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename=workout-plan-${workoutId}.pdf`,
    );
    ...
    if (workoutPlan.description) {
      doc
        .fontSize(12)
        .font("Helvetica")
        .text(workoutPlan.description, { align: "center" });
      doc.moveDown(1);
    }
    ...
    if (content.introduction) {
      ...
      if (content.introduction.preparation) {
        ...
        doc
          .fontSize(10)
          .font("Helvetica")
          .text(content.introduction.preparation);
        doc.moveDown(0.5);
      }
    ...
    if (content.mainWorkout) {
      ...
      content.mainWorkout.forEach((circuit: any, index: number) => {
        ...
        doc
          .fontSize(14)
          .font("Helvetica-Bold")
          .text(`Circuit ${circuit.circuitNumber || index + 1}`);
        doc.moveDown(0.5);
        ...
        if (circuit.exercises && circuit.exercises.length > 0) {
          ...
          circuit.exercises.forEach((exercise: any, exIndex: number) => {
            ...
            doc
              .fontSize(12)
              .font("Helvetica-Bold")
              .text(exercise.exercise, 60, startY + 10);
            ...
            doc
              .fontSize(10)
              .font("Helvetica-Bold")
              .text("Reps:", col1X, startY + 30);
            doc
              .fontSize(10)
              .font("Helvetica")
              .text(exercise.reps || "N/A", col1X + 40, startY + 30);

            doc
              .fontSize(10)
              .font("Helvetica-Bold")
              .text("Sets:", col1X, startY + 45);
            doc
              .fontSize(10)
              .font("Helvetica")
              .text(exercise.sets || "N/A", col1X + 40, startY + 45);

            if (exercise.men) {
              doc
                .fontSize(10)
                .font("Helvetica-Bold")
                .text("Men:", col1X, startY + 60);
              doc
                .fontSize(10)
                .font("Helvetica")
                .text(exercise.men, col1X + 40, startY + 60);
            }
            ...
            if (exercise.woman) {
              doc
                .fontSize(10)
                .font("Helvetica-Bold")
                .text("Women:", col2X - 50, startY + 60);
              doc
                .fontSize(10)
                .font("Helvetica")
                .text(exercise.woman, col2X - 5, startY + 60);
            }

            doc
              .fontSize(10)
              .font("Helvetica-Bold")
              .text("Technique:", col2X, startY + 30);
            ...
            doc
              .fontSize(10)
              .font("Helvetica")
              .text(techniqueText, col2X + 60, startY + 30, {
    ...
    if (content.recovery) {
      ...
      if (content.recovery.restRecommendations) {
        ...
        doc
          .fontSize(10)
          .font("Helvetica")
          .text(content.recovery.restRecommendations);
        doc.moveDown(0.5);
      }
      ...
      if (content.recovery.nextDayGuidance) {
        ...
        doc
          .fontSize(10)
          .font("Helvetica")
          .text(content.recovery.nextDayGuidance);
        doc.moveDown(0.5);
      }
    }
